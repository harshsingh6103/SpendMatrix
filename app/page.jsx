  ...
  return (
    <div className="flex flex-col pt-16">
      ...
      <section className="mt-20 pb-12 space-y-10 md:space-y-15 px-5">
        <div className="container mx-auto px-4 md:px-6 text-center space-y-6">
          ...
          <h1 className="gradient-title mx-auto max-w-6xl text-4xl font-bold md:text-8xl">
            The smartest way to manage expenses between friends 
          </h1>

          <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl/relaxed">
            Expense management that thinks for you—automating tracking, analyzing patterns, and giving smart insights instantly
          </p>
      ...
      <footer className="border-t bg-gray-50 py-12 text-center text-sm text-muted-foreground">
        © {new Date().getFullYear()} SpendMatrix. All rights reserved.
      </footer>
    </div>
  );
}
